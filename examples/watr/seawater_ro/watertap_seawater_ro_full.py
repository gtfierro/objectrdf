...
def build_model() -> Model:
    ...
    with model:
        # Flowsheet feed. Current WaTr treats seawater, freshwater, and brine
        # as mutually distinct media, so this transforming topology uses their
        # shared broad water type and describes composition with properties.
        feed = Equipment(
            "feed",
            label="Seawater feed",
        ...
        influent = stream_state(feed_out, medium=enums.Fluid_Water)
        influent.quantity(
            QuantifiableProperty,
            "influent-flow-rate",
            7.05e6,
        ...
        # The shared broad water type keeps the S223 Filter constraint valid
        # across the seawater-to-permeate-and-brine transformation.
